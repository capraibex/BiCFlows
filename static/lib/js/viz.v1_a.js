!function(){
  ...
  viz2.bP = function(){
      ...
      // sort
      var pArray = mainBars[part].map(function(d){return d.key;});
      ps.sort(function(a,b){
        return pArray.indexOf(a.key) - pArray.indexOf(b.key);
      });
      part2 = (part=="primary") ? "secondary" : "primary";
      pArray = mainBars[part2].map(function(d){return d.key;});
